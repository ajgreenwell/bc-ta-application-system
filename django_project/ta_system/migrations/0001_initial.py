# Generated by Django 3.0.3 on 2020-03-25 21:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_num_tas', models.PositiveIntegerField(default=2, validators=[ta_system.validators.DataValidator(message="Please enter the maximum number of TAs that can be assigned to thiscourse, e.g. '3'. This field defaults to '2'.", regex='\\d+')], verbose_name='Max Number of TAs')),
            ],
            options={
