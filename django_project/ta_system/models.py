...
from .data_formats.course_data_formats import DATA_FORMATS as COURSE_DATA_FORMATS
from .data_formats.applicant_data_formats import DATA_FORMATS as APPILCANT_DATA_FORMATS
...
class Profile(models.Model):
    ...
    ta_assignments = models.ManyToManyField(
        Course, through='Course_teaching_assistants', verbose_name="TA Assignments", blank=True
    )

    def __str__(self):
        return f'{self.eagle_id}: {self.user.last_name}, {self.user.first_name}'
